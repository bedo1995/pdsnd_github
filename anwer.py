...
def data_clean():
    ...
    #Creating a dictionary to store all the day
...
def station_calc(df):
    ...
    # Create new column with start to end using cat method and use mode
...
def user_info(df, city):
    ...
    if city != 'washington':
        ...
        # excuting number of users by birth year for both chicago and new york files but not for
